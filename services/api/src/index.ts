...
const PLAN_LIMITS:Record<string,{tables:number;staff:number;menuItems:number;analyticsDays:number;locations:number}>={starter:{tables:5,staff:2,menuItems:15,analyticsDays:7,locations:1},growth:{tables:15,staff:6,menuItems:45,analyticsDays:30,locations:1},business:{tables:30,staff:20,menuItems:150,analyticsDays:90,locations:1},pro:{tables:30,staff:20,menuItems:150,analyticsDays:90,locations:1},enterprise:{tables:1000,staff:1000,menuItems:5000,analyticsDays:730,locations:1000}};
