...
function Pricing({ dashboardHref }: SharedProps) {
  const plans = [
    ...
    { name: "Growth", price: "₹3,499", detail: "For busy restaurants connecting the dining room, kitchen, and payments.", capacity: "15 tables · 6 staff · 45 menu items", features: ["Everything in Starter", "UPI, card, and counter payments", "30 days of operational reporting", "Priority support"], featured: true },
    { name: "Business", price: "₹7,999", detail: "For higher-volume operations that need more capacity and hands-on setup.", capacity: "30 tables · 20 staff · 150 menu items", features: ["Everything in Growth", "90 days of operational reporting", "Highest operating limits", "Managed onboarding"] },
    { name: "Special Event", price: "Custom", detail: "Flexible Grabtu setup for temporary, high-traffic, and one-off event operations.", capacity: "Tailored capacity · Event-ready setup", features: ["Festivals", "Conventions and Expos", "Local Night Markets", "College and Corporate Fests", "Any sorts of event"], custom: true },
  ];
  const comparison = [
    ...
    ["Tables", "Up to 5", "Up to 15", "Up to 30"],
  ...
  const faqs = [
    ...
    ["What makes Business the premium plan?", "Business raises the supported capacity to 30 tables, 20 staff members, and 150 menu items, extends operational reporting to 90 days, and includes managed onboarding."],
